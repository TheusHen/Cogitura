...
from cogitura.utils import sanitize_filename, hash_text
...
class TTSProcessor:
    ...
    def __init__(
        ...
        log.info(f"TTSProcessor inicializado - idioma: {self.language}, diretório: {self.output_dir}")
