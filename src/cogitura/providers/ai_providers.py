    ...
    def generate_sentence(self, prompt: Optional[str] = None) -> str:
        ...
        try:
            response = self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are a helpful assistant that generates simple English sentences."},
...
def get_provider(provider_name: Optional[str] = None, config: Optional[Dict[str, Any]] = None) -> AIProvider:
    """
